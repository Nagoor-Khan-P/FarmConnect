        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {data.recommendedYields.map((item) => (
              <Card key={item.yieldId} className="border-l-4 border-l-secondary bg-card/40">
                ...
                <CardContent>
                  ...
                  <Button variant="link" className="p-0 h-auto mt-4 text-secondary font-bold group">
                    View listing <ArrowRight className="ml-1 h-3 w-3 group-hover:translate-x-1 transition-transform" />
                  </Button>
                </CardContent>
              </Card>
            ))}
